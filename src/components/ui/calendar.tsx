// C:\Users\Yummie03\Desktop\datingapp\src\components\ui\calendar.tsx
"use client";
...
// Use a type alias (not interface) because DayPickerProps is a union type in v9
...
const Calendar = ({
  ...
  return (
    <DayPicker
      /** keep this typed by DayPickerProps so TS knows "mode" exists */
