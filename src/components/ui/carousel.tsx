// C:\Users\Yummie03\Desktop\datingapp\src\components\ui\carousel.tsx
"use client";
...
function Carousel(
  ...
  // Embla event callbacks don't receive api as an argument; read from closure.
  ...
  React.useEffect(() => {
    ...
    // ✅ Cleanup must return void. Call off() inside the cleanup body.
    return () => {
